...
// Restore Home view on scroll-up
window.addEventListener('scroll', () => {
  if (window.scrollY < 100) {
    // Remove section-show classes
    $('section').removeClass('section-show');

    // Reset header to full layout
    $('#header').removeClass('header-top');
    $('#intro-greeting').css('display', 'block');

    // Reset nav menu active link
